...
function getHourlyReport(file_type='view')
{
	...
	if(file_type == 'view')
	{
		$.ajax({
			...
			type:'post',
			data:{month:month,dept_id:dept_id,file_type:file_type,record_limit:record_limit},
			dataType:'json',
			success:function(data){
	...
	{
		window.open(base_url + controller + '/getHourlyReport/' + month + '/' + dept_id + '/' + file_type + '/' + record_limit, '_blank').focus();
	}
}
...
function printMonthlyAttendance(file_type)
{
    ...
    var record_limit = $("#record_limit").val();
    var month = $("#month").val();
	window.open(base_url + controller + '/printMonthlyAttendance/'+dept_id+'/'+month+'/'+file_type+'/'+record_limit, '_blank').focus();
}
...
function printMonthlySummary(file_type)
{
	...
	window.open(base_url + controller + '/printMonthlySummary/' +from_date+'~'+to_date+'/'+biomatric_id+'/'+shift_id+'/'+file_type, '_blank').focus();
}
/*
