...
*/  
    public function salesOrderList(){
        ...
        $total_rows = $this->salesOrder->getCount($status);

        $config = array();
        $config["base_url"] = base_url() . "api/v1/salesOrder/salesOrderList";
        ...
        $this->data['salesOrderList'] = $this->salesOrder->getSalesOrderList_api($config["per_page"], $page, $status);
