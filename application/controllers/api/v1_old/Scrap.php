...
<?php
class Scrap extends MY_Apicontroller{
...
*/  
    ...
    public function scrapList(){
        $total_rows = $this->jobcard->getCount();

        $config = array();
        $config["base_url"] = base_url() . "api/v1/scrap/scrapList";
        ...
        $this->data['scrapList'] = $this->jobcard->getJobCardList_api($config["per_page"], $page);
