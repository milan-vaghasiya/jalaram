...
*/  
    public function salesQuotationList(){
        ...
        $total_rows = $this->salesQuotation->getCount($status);

        $config = array();
        $config["base_url"] = base_url() . "api/v1/salesQuotation/salesQuotationList";
        ...
        $this->data['salesQuotationList'] = $this->salesQuotation->getSalesQuotationList_api($config["per_page"], $page, $status);
