...
class ToolsIssue extends MY_Apicontroller{
    ...
    public function ToolsIssueList(){
        $total_rows = $this->toolsIssue->getCount();

        $config = array();
        $config["base_url"] = base_url() . "api/v1/toolsIssue/toolsIssueList";
        ...
        $this->data['toolsIssueList'] = $this->toolsIssue->getToolsIssueList_api($config["per_page"], $page);
