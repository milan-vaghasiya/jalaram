...
{	   
    ...
    /* IOT Header */
    $data['iotConfig'][] = ["name" => "#", "style" => "width:5%;", "textAlign" => "center", "srnoPosition" => 0];
    $data['iotConfig'][] = ["name" => "Description <br>of Machine"];
    $data['iotConfig'][] = ["name" => "Code No."];
    $data['iotConfig'][] = ["name" => "Action", "style" => "width:15%;", "textAlign" => "center"];
...
/* Iot Config Data  */
function getIotConfigData($data)
{
 
    $btn = '<div class="btn-group" role="group" aria-label="Basic example">
                <button type="button" class="btn btn-info addIdleTime permission-modify" data-id="' . $data->id . '" data-machine_code="' . $data->item_code . '" data-button="both" data-modal_id="modal-md" data-function="getIdleTime" data-form_title="Idle Time" datatip="Idle Time" flow="left"><i class="fas fa-info"></i></button>
            </div>';

    return [$data->sr_no, $data->item_name, $data->item_code, $btn];
}
