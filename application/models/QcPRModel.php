...
class QcPRModel extends MasterModel{
    ...
    public function getDTRows($data){
        $data['tableName'] = $this->qc_indent;
        $data['select'] = "qc_indent.*,DATE_FORMAT(qc_indent.created_at,'%d-%m-%Y') as req_date,CONCAT('[',item_category.category_name,'] ',item_category.category_name) as category_name,employee_master.emp_name as rejected_by";
    ...
    public function sizeSearch($category_id=0){
		$data['tableName'] = 'qc_instruments';
		$data['select'] = 'DISTINCT(size)';
