...
class TaxMasterModel extends MasterModel{
	...
	public function getDTRows($data){
        ...
        (CASE WHEN tax_master.calculation_type = 0 THEN "Qty" WHEN tax_master.calculation_type = 1 THEN "Amount" WHEN tax_master.calculation_type = 2 THEN "Net Amount" ELSE ""  END) as calc_type_name,
