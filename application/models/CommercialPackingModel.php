...
class CommercialPackingModel extends MasterModel{
    ...
    public function getPackingNoList($party_id){
        ...
        $queryData['where']['export_packing.packing_type'] =2;
    ...
    public function getCustomerPOData($packing_ids){
        ...
        $queryData['leftJoin']['trans_main'] = "export_packing.so_id = trans_main.id";
        $queryData['where_in']['export_packing.id'] = $packing_ids;
        ...
        try{
            ...
            if(!empty($masterData['id'])):
                ...
                foreach($transData as $row):
                    $this->edit($this->export_packing,['id'=>$row->ref_id],['comm_pack_id'=>0,'status'=>0]);
                endforeach;
            ...
            foreach($itemData as $row):
                ...
                //if(empty($row['id'])){
                    ...
                    $comm_pack_id = (empty($row['id']))?$trasnResult['insert_id']:$row['id'];
                    $this->edit($this->export_packing,['id'=>$row['ref_id']],['comm_pack_id'=>$comm_pack_id,'status'=>1]);
    ...
    public function getCommercialPackingItemsGroupByBox($id){ 
        $queryData = array();
        $queryData['tableName'] = $this->transChild;
        $queryData['select'] = "trans_child.*,item_master.price as so_price,export_packing.status as packing_status,LPAD(export_packing.package_no, 2, '0') as package_no,item_master.part_no as PartNo,item_master.drawing_no as DrgNo,item_master.rev_no as RevNo,som.currency,export_packing.wooden_size,export_packing.pack_weight,export_packing.wooden_weight";
        $queryData['leftJoin']['export_packing'] = "export_packing.id = trans_child.ref_id";
        $queryData['leftJoin']['trans_child as soi'] = "export_packing.comm_pack_id = soi.id";
        $queryData['leftJoin']['trans_main as som'] = "export_packing.so_id = som.id";
        $queryData['leftJoin']['item_master'] = "item_master.id = trans_child.item_id";
    ...
    public function getCommercialInvItemsGroupByBox($id){ 
        $queryData = array();
        $queryData['tableName'] = $this->transChild;
        $queryData['select'] = "trans_child.*,item_master.price as so_price,export_packing.status as packing_status,LPAD(export_packing.package_no, 2, '0') as package_no,item_master.part_no as PartNo,item_master.drawing_no as DrgNo,item_master.rev_no as RevNo,som.currency,export_packing.wooden_size,export_packing.pack_weight,export_packing.wooden_weight";
        $queryData['leftJoin']['trans_child as child'] = "child.id = trans_child.ref_id";
        $queryData['leftJoin']['export_packing'] = "export_packing.id = child.ref_id";
        $queryData['leftJoin']['trans_child as soi'] = "export_packing.comm_pack_id = soi.id";
        $queryData['leftJoin']['trans_main as som'] = "export_packing.so_id = som.id";
        $queryData['leftJoin']['item_master'] = "item_master.id = trans_child.item_id";
        $queryData['where']['trans_child.trans_main_id'] = $id;
    ...
    public function getCustomInvItemsGroupByBox($id){ 
        $queryData = array();
        $queryData['tableName'] = $this->transChild;
        $queryData['select'] = "trans_child.*,item_master.price as so_price,export_packing.status as packing_status,LPAD(export_packing.package_no, 2, '0') as package_no,item_master.part_no as PartNo,item_master.drawing_no as DrgNo,item_master.rev_no as RevNo,som.currency,export_packing.wooden_size,export_packing.pack_weight,export_packing.wooden_weight";
        $queryData['leftJoin']['trans_child as custChild'] = "custChild.id = trans_child.ref_id";
        $queryData['leftJoin']['trans_child as comChild'] = "comChild.id = custChild.ref_id";
        $queryData['leftJoin']['export_packing'] = "export_packing.id = comChild.ref_id";
        $queryData['leftJoin']['trans_child as soi'] = "export_packing.comm_pack_id = soi.id";
        $queryData['leftJoin']['trans_main as som'] = "export_packing.so_id = som.id";
        $queryData['leftJoin']['item_master'] = "item_master.id = trans_child.item_id";
        $queryData['where']['trans_child.trans_main_id'] = $id;
