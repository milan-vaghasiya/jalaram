    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <input type="date" name="req_date" id="req_date" class="form-control req" min="<?=$startYearDate?>" max="<?=$maxDate?>" value="<?=$maxDate?>">
            </div>
                ...
                <select name="fg_item_id" id="fg_item_id" class="form-control single-select req">
                    ...
                    <?php 
                        foreach($fgData as $row):
                            echo '<option value="'.$row->id.'" data-item_type="'.$row->item_type.'">'.$row->item_code.' </option>';
                        endforeach;
                    ?>
                </select>
            </div>
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" name="req_qty" id="req_qty" class="form-control floatOnly req" min="0" value="<?=(!empty($dataRow))?(($dataRow->req_qty != "0.000")?$dataRow->req_qty:$dataRow->req_qty):""?>">                
            </div>
