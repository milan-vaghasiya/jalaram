                        ...
                        <form id="addMasterOptions">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <label for="ins_instruments">Instrument Used</label>
                                        <input name="ins_instruments" id="ins_instruments" class="form-control req" value="<?= (!empty($dataRow->ins_instruments)) ? $dataRow->ins_instruments : "" ?>" data-role="tagsinput">
                                    </div>
                                    <div class="col-md-12 form-group">
