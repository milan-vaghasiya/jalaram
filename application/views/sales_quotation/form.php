                            ...
                            <div class="col-md-12">
								...
								<div class="row form-group">
									...
									<div class="col-md-2">
										...
										<input type="date" id="trans_date" name="trans_date" class=" form-control req" placeholder="dd-mm-yyyy" aria-describedby="basic-addon2" value="<?=(!empty($dataRow->trans_date))?$dataRow->trans_date:$maxDate?>" min="<?=$startYearDate?>" max="<?=$maxDate?>" <?=(!empty($is_revision) || !empty($dataRow->quote_rev_no))?'readonly':''?> />	
									</div>
									...
									<div class="col-md-3 form-group">
										...
										<select name="contact_person" id="contact_person" class="form-control single-select req">
											...
											<?php 
												if(!empty($dataRow->contact_person)){ echo $dataRow->contact_person; }elseif(!empty($quotationData->contact_person)){ echo $quotationData->contact_person;  }
											?>
										</select>
									</div>
									...
									<div class="col-md-3 form-group">
										...
										<select name="contact_no" id="contact_no" class="form-control single-select req">
											...
											<?php 
												if(!empty($dataRow->contact_no)){ echo $dataRow->contact_no; }elseif(!empty($quotationData->contact_no)){ echo $quotationData->contact_no;  }
											?>
										</select>
									</div>
									<div class="col-md-3 form-group">
										...
										<select name="contact_email" id="contact_email" class="form-control single-select req">
											...
											<?php 
												if(!empty($dataRow->contact_email)){ echo $dataRow->contact_email; }elseif(!empty($quotationData->contact_email)){ echo $quotationData->contact_email; }
											 ?>
										</select>
									</div>
												...
												?>
													<tr>
														...
														<td>
															...
															<input type="hidden" name="close_reason[]" value="<?=$row->close_reason?>" />
															<input type="hidden" name="packing_qty[]" value="<?=$row->packing_qty?>" />
														</td>
														<td>
															<?=$row->drg_rev_no?>
													...
													<tbody>
														...
														?>
															<tr>
																...
																<td style="width:65%;">
																	<textarea rows="1" type="text" name="condition[]" id="condition<?=$i?>" class="form-control" <?=$disabled?> ><?=$row->conditions?></textarea>
																</td>
															</tr>
														<?php
																	$i++;
                ...
                <form id="quotationItemForm">
                    <div class="col-md-12">
                        ...
                        <div class="row form-group">
							...
							<div class="col-md-6 form-group">
								<label for="disc_per">Discount(%)</label>
							...
							<div class="col-md-4 form-group">
								<label for="batch_qty">M.O.Q.</label>
								<input type="text" name="batch_qty" id="batch_qty" class="form-control" value="" />
							</div>
							<div class="col-md-4 form-group">
								<label for="close_reason">R.M. Grade</label>
								<input type="text" name="close_reason" id="close_reason" class="form-control" value="" />
							</div>
							<div class="col-md-4 form-group">
                                <label for="packing_qty">Sample Charge</label>
                                <input type="text" name="packing_qty" id="packing_qty" class="form-control" value="">
                            </div>
                            <div class="col-md-12 form-group">
...
<?php
	if(!empty($quotationData->itemData)){
		foreach($quotationData->itemData as $row):
			unset($row->quote_rev_no);
			if(empty($row->trans_status) AND $row->feasible == "Yes"):
				$row->trans_id = "";
