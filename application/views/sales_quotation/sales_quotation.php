    ...
    <div class="col-md-12">
		...
		<div class="row">
			...
			<div class="col-md-3">
				...
				<input type="date" id="quotation_date" name="quotation_date" class=" form-control req" placeholder="dd-mm-yyyy" aria-describedby="basic-addon2" value="<?=(!empty($dataRow->quotation_date))?$dataRow->quotation_date:$maxDate?>" min="<?=$startYearDate?>" max="<?=$maxDate?>" />	
			</div>
