            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-center">
                        <h4><u>Commercial Invoice</u></h4>
                    </div>
                    <div class="card-body">
                        <form autocomplete="off" id="commercialInvoiceForm">
                            <div class="col-md-12">
				...
				<div class="card-footer">
					<div class="col-md-12">
						<button type="button" class="btn waves-effect waves-light btn-outline-success float-right save-form" onclick="saveInvoice('commercialInvoiceForm');" ><i class="fa fa-check"></i> Save</button>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12 form-group">
								...
								<input type="text" name="item_name" id="item_name" class="form-control" value="" readonly/>								
                            </div>
