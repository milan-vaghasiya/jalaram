                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
								<select name="report_type" id="report_type" class="form-control single-select">
									...
									<option value="1">QC Purchase</option>
								</select>
							</div>
                            <div class="col-md-2">
                            ...
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
                                    <tr class="text-center">
                                        <th colspan="11">Purchase Inward</th>
                                    </tr>
									<tr class="text-center">
										<th>#</th>
    ...
    $(document).on('click','.loaddata',function(e){
		...
		if(valid)
		{
            $.ajax({
                ...
                data: {item_type:item_type,category_id:category_id,from_date:from_date,to_date:to_date,report_type:report_type},
				type: "POST",
				dataType:'json',
				success:function(data){
					console.log(data);
