                            ...
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
									<tr>
										...
										<th style="min-width:50px;">Defect Belong To Rework</th>
										...
										<th style="min-width:50px;">Defect Belong To Rejection</th>
    ...
    $(document).on('click','.loaddata',function(e){
		...
		if(valid)
		{
            $.ajax({
                ...
                data: {item_id:item_id,from_date:from_date, to_date:to_date,rtype:2},
				type: "POST",
				dataType:'json',
