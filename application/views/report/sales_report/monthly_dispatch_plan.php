                ...
                <div class="card">
                    <div class="card-header">
						...
						<div class="row">
                            ...
                            <div class="col-md-2">   
                                <input type="date" name="prod_from_date" id="prod_from_date" class="form-control" value="<?=date('Y-m-01')?>" />
                                <div class="error fromDate"></div>
                            </div>     
                            <div class="col-md-3">  
                                <div class="input-group">
                                    <input type="date" name="prod_to_date" id="prod_to_date" class="form-control" value="<?=date('Y-m-d')?>" />
                        ...
                        <div class="table-responsive">
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
                                    <tr class="thead-info">
           							    <th colspan="6"class="text-center">Monthly Dispatch Plan</th>
...
$(document).ready(function(){
    ...
    $(document).on('click','.loaddata',function(e){
		...
		var prod_from_date = $('#prod_from_date').val();
		var prod_to_date = $('#prod_to_date').val();
		if($("#prod_from_date").val() == ""){$(".fromDate").html("From Date is required.");valid=0;}
		if($("#prod_to_date").val() == ""){$(".toDate").html("To Date is required.");valid=0;}
		if($("#prod_to_date").val() < $("#prod_from_date").val()){$(".toDate").html("Invalid Date.");valid=0;}
		if(valid)
		{
            $.ajax({
                url: base_url + controller + '/getmonthlydispatchPlan',
                data: {party_id:party_id,sales_type:sales_type,prod_from_date:prod_from_date, prod_to_date:prod_to_date},
				type: "POST",
				dataType:'json',
