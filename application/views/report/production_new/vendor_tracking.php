						...
						<div class="row">
							...
							<div class="col-md-2 form-group">
								<select name="report_type" id="report_type" class="form-control">
									...
									<option value="2">Bag/Caret Wise</option>
								</select>
							</div>
							<div class="col-md-2 form-group">   
							...
							<table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
									<tr>
										...
										<th style="min-width:100px;">Out Qty</th>
										<th style="min-width:100px;">In Qty</th>
										<th style="min-width:100px;">Pend. Qty</th>
									</tr>
								</thead>
...
<script>
	...
	reportTable();
        ...
        $(document).on('click','.loaddata',function(e){
            ...
            var vendor_id = $('#vendor_id :selected').val();
            ...
            {
                $.ajax({
                    url: base_url + controller + '/getVendorTracking',
                    data: {report_type:report_type,vendor_id:vendor_id,from_date:from_date, to_date:to_date},
                    type: "POST",
                    dataType:'json',
