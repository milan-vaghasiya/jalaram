            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body reportDiv" style="min-height:75vh">
                        ...
                        <div class="table-responsive">
                            <table id='wipTable' class="table table-bordered">
								<thead class="thead-info" id="wipTheadData">
									<tr>
										<th colspan="2">WIP Stock</th>
										<th id="wip_stock" class="text-center"></th>
									</tr>
									<tr>
										<th>#</th>
										<th>Store</th>
		...
		if(item_id)
		{
			$.ajax({
				...
				success:function(data){
					...
					$("#wipTable").dataTable().fnDestroy();
					$("#wipTbodyData").html(data.wipHTML);
					$("#wip_stock").html(data.total_wip_qty);
					reportTable('wipTable');
				}
			});
		}
