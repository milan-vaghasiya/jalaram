                ...
                <div class="card">
					...
					<div class="row form-group">
						...
						<div class="row form-group">
							...
							<div class="col-md-4">  
								    <select id="itemid" data-input_id="item_id" class="form-control jp_multiselect req" multiple="multiple"></select>
                            ...
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
                                    <tr class="text-center">
                                        ...
                                        <th colspan="2">F ST 08 (00/01.06.20)</th>
                                        <th class="totalUP"></th>
...
$(document).ready(function(){
	...
	$(document).on('change','#item_type', function(e){ 
		...
		if(item_type){
			$.ajax({
                url: base_url + controller + '/getItemForInventoryMonitor',
    ...
    $(document).on('click','.loaddata',function(e){ 
		...
		if(valid)
		{
            $.ajax({
                ...
                data: {item_type:item_type,item_id:item_id,from_date:from_date, to_date:to_date},
				type: "POST",
				dataType:'json',
				success:function(data){
