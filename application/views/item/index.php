            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title"><?=$item_type == 3 ? "Raw Material Items":"Consumable Items"?></h4>
                            </div>
                            <div class="col-md-6">
                                <?php if($item_type == 2){ ?>
                                        
                                    <div class="input-group">
                                        <select id="category_id_filture" class="form-control">
...
$(document).ready(function(){
    $(document).on('change','#category_id_filture',function(){
