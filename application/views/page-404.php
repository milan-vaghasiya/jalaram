            ...
            <div class="error">
                <div class="container-floud">
                    <div class="col-md-12 ground-color text-center">
                        <img src="<?=base_url('assets/images/logo.png')?>" style="width:300px;margin-top:10px;"/>
                        ...
                        <a href="<?=base_url()?>" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Back to home</a>
                    </div>
                </div>
            </div>
        <!-- Error Page -->
