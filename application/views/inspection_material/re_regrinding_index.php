                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item"> <a href="<?= base_url($headData->controller . "/pendingRegrindingIndex/0") ?>" class="nav-link btn waves-effect waves-light btn-outline-info mr-1 active">Pending Regrinding </a> </li>
                                    ...
                                    <li class="nav-item"> <a href="<?= base_url($headData->controller . "/regrindingInspection/0") ?>" class="nav-link btn waves-effect waves-light btn-outline-info mr-1 ">Regrinding Inspection </a> </li>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='inspectionTable' class="table table-bordered ssTable" data-url='/getReRegrindingDTRows/'></table>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).on('click', '.bulkRegrindingCh', function() {
    ...
    var  button = "both"; if (button == "" || button == null) {;  };
                    ...
                    $.ajax({ 
                        type: "POST",   
                        url: base_url + controller + '/createReRegrindingChallan',   
                        data: sendData,
