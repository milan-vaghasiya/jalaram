                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <ul class="nav nav-pills">
                                        ...
                                        <a href="<?= base_url($headData->controller . "/appPermission/") ?>" class="btn waves-effect waves-light btn-outline-dark permission-write active"> App Permission</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="hidden" id="menu_type" name="menu_type" value="<?=!empty($menu_type)?$menu_type:"2";?>">
