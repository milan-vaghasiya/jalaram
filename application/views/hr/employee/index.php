                        ...
                        <div class="row">
                            <div class="col-md-4">  
                                <ul class="nav nav-pills">
                                    <li class="nav-item"> <button onclick="statusTab('employeeTable',0);" class=" btn waves-effect waves-light btn-outline-success active" style="outline:0px" data-toggle="tab" aria-expanded="false">Active</button> </li>
                                    <li class="nav-item"> <button onclick="statusTab('employeeTable',1);" class=" btn waves-effect waves-light btn-outline-danger" style="outline:0px" data-toggle="tab" aria-expanded="false">Inactive</button> </li>
                                </ul>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <button type="button" class="btn waves-effect waves-light btn-outline-primary float-right addNew permission-write" data-button="both" data-modal_id="modal-xl" data-function="addEmployee" data-form_title="Add Employee"><i class="fa fa-plus"></i> Add Employee</button>
                            </div>                             
                        </div>                                         
                    </div>
                    <div class="card-body">
