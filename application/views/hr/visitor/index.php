    ...
    <div id="appCapsule" style="padding: 0px;">
        ...
        <div class="row">
            <div class="section mb-5 p-1">
                ...
                <div class="card">
                    <div class="card-body pb-1">
                        <ul class=" no-line " style="font-size:12px">
                            <li>Wear appropriate safety gear such as helmets, goggles, and gloves.</li>
                            <li>Follow designated pathways and safety signs.</li>
                            <li>Keep a safe distance from machinery and moving parts.</li>
                            <li>Do not touch any equipment without permission.</li>
                            <li>Listen to instructions from your guide or supervisor at all times.</li>
                        </ul> 
                    </div>
                </div>
                <div class="form-button-group transparent">
                    <button type="button" class="btn btn-primary btn-block square me-1 btn-lg appointmentForm">Get Appointment</button>
                </div>
            </div>
        </div>
    </div>
