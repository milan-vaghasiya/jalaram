                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="button" class="btn waves-effect waves-light btn-outline-primary float-right addNew" data-button="both" data-modal_id="modal-lg" data-function="addCtcFormat" data-form_title="Add CTC Format"><i class="fa fa-plus"></i> Add CTC Format</button>
                            </div>                             
                        </div>                                         
                    </div>
                    <div class="card-body">
