							...
							<div class="col-md-12">
								...
								<div class="row form-group">
									...
									<div class="col-md-2">
										...
										<input type="date" id="trans_date" name="trans_date" class=" form-control req" placeholder="dd-mm-yyyy" value="<?= (!empty($creditData->trans_date)) ? $creditData->trans_date : $maxDate ?>"  min="<?=$startYearDate?>" max="<?=$maxDate?>" />
									</div>
									<div class="col-md-3">
								...
								<div class="row form-group">
									...
									<div class="col-md-2 form-group">
										...
										<input type="text" name="credit_period" id="credit_period" class="form-control numericOnly" value="<?=(!empty($creditData->credit_period))?$creditData->credit_period:""?>">
									</div>
									<div class="col-md-2">
					...
					<div class="col-md-12">
						...
						<div class="row form-group">
							...
							<div class="col-md-6 form-group">
								<label form="item_name">Item Description</label>
