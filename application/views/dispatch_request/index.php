                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"> <button onclick="statusTab('dispatchRequsetTable',0);" data-status="0" class=" btn waves-effect waves-light btn-outline-info active" style="outline:0px" data-toggle="tab" aria-expanded="false">Pending</button> </li>
                                    <li class="nav-item"> <button onclick="statusTab('dispatchRequsetTable',1);" data-status="1" class=" btn waves-effect waves-light btn-outline-success" style="outline:0px" data-toggle="tab" aria-expanded="false">Completed</button> </li>
                                    <li class="nav-item"> <button onclick="statusTab('dispatchRequsetTable',3);" data-status="3" class=" btn waves-effect waves-light btn-outline-danger" style="outline:0px" data-toggle="tab" aria-expanded="false">Short Closed</button> </li>
                                </ul>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control single-select" id="party_id_filter" name="party_id_filter" style="width: 30%;">
                                    ...
                                    <select name="item_id_filter" id="item_id_filter" class="form-control single-select" style="width: 30%;">
                                    ...
                                    <div class="input-group-append">
                                        <button type="button" class="btn waves-effect waves-light btn-success float-right loaddata" title="Load Data"><i class="fas fa-sync-alt"></i></button>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='dispatchRequsetTable' class="table table-bordered ssTable" data-url='/getDTRows'></table>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function(){
    ...
    $(document).on('click','.changeReqStatus',function(){
		var id = $(this).data('id');
		...
		$.confirm({
			title: 'Confirm!',
			content: 'Are you sure want to Short Close this Request?',
			type: 'green',
			buttons: {   
				ok: {
					text: "ok!",
					...
					action: function(){
						$.ajax({
							url: base_url + controller + '/changeReqStatus',
...
function loadDataTable(status){
    ...
    $("#dispatchRequsetTable").attr("data-url",'/getDTRows/'+status+'/'+party_id_filter+'/'+item_id_filter);
