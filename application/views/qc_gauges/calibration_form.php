<form>
    <div class="col-md-12">
        <div class="row">
			...
			<input type="hidden" name="cal_agency" id="cal_agency" value="<?= (!empty($dataRow->party_id)) ? $dataRow->party_id : 0; ?>" />
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" name="during_remark" class="form-control  text-center"></td>
                            </tr>
                            <tr>
                                ...
                                <td><input type="text" name="after_remark" class="form-control  text-center"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="col-md-12 form-group">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th style="width:25%;">Size (Go): </th><td style="width:25%;"><?=$dataRow->size_go?></td>
                        <th style="width:25%;">Acceptance Criteria (Go): </th><td style="width:25%;"><?=$dataRow->ac_go?></td>
                    </tr>
                    <tr>
                        <th style="width:25%;">Size (No Go) : </th><td style="width:25%;"><?=$dataRow->size_nogo?></td>
                        <th style="width:25%;">Acceptance Criteria (No Go): </th><td style="width:25%;"><?=$dataRow->ac_nogo?></td>
                    </tr>	
                </table>
            </div>
            <div class="col-md-12 form-group">
