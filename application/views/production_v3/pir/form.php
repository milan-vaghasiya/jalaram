                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form autocomplete="off" id="pir_form">
                            ...
                            <div class="col-md-12">
                                <?php
                                $sample_size =1; //(!empty($dataRow->sampling_qty) ? $dataRow->sampling_qty : (!empty($paramData[0]->sev)?$paramData[0]->sev:1));
                                ?>
                                <div class="row">
                                    ...
                                    <input type="hidden" name="grn_id" id="grn_id" value="<?= (!empty($dataRow->grn_id)) ? $dataRow->grn_id : $job_card_id ?>">
                                    ...
                                    <div class="col-lg-12 col-xlg-12 col-md-12">
                                        <table class="table table-bordered-dark">
                                            ...
                                            <tr>
                                                ...
                                                <td><?= (!empty($dataRow->item_name)?'['.$dataRow->item_code.']'.$dataRow->item_name:'['.$jobData->product_code.']'.$jobData->product_name) ?></td>
                                                <td><?= (!empty($dataRow->party_id)?'[' . $dataRow->machine_code . '] ' . $dataRow->machine_name:'[' . $machine_code . '] ' . $machine_name) ?></td>
                                    ...
                                    <div class="col-md-2 form-group">
                                        ...
                                        <input type="date" name="trans_date" id="trans_date" class="form-control" value="<?= (!empty($dataRow->trans_date)) ? $dataRow->trans_date : date("Y-m-d") ?>">
                                    </div>
                                    <div class="col-md-2 form-group">
                                        <label for="party_id">Machine</label>
                                        <select id="party_id" name="party_id" class="form-control single-select">
                                            ...
                                            if(!empty($machineList)){
                                                foreach($machineList as $row){
                                                    ...
                                                    ?>
                                                    <option value="<?=$row->id?>" <?=$selected?>><?='['.$row->item_code.']'.$row->item_name?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
									...
									<div class="col-md-2 form-group">
                                        ...
                                        <select id="operator_id" name="operator_id" class="form-control single-select">
                                        ...
                                        <table id="pirTable" class="table table-bordered generalTable">
                                            <thead class="thead-info" id="theadData">
                                                ...
                                                <tr style="text-align:center;">
                                                    ...
                                                    ?>
                                                        <th><input type="time" class="form-control" name="report_time[]" value="<?=!empty($reportTime[$c])?$reportTime[$c]:''?>"></th>
                                                    <?php
                                                    endfor;
                                                    ?>
                    ...
                    <div class="card-footer">
                        <div class="col-md-12">
                            ...
                            <a href="<?= base_url('production_v3/pir/pirIndex') ?>" class="btn waves-effect waves-light btn-outline-secondary float-right save-form" style="margin-right:10px;"><i class="fa fa-times"></i> Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    function saveReport(formId) {
        ...
        $.ajax({
            ...
            if (data.status === 0) {
                ...
                window.location = base_url + controller+'/pirIndex';
            } else {
