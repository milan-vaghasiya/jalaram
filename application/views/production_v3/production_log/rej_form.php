    ...
    <div class="col-md-12">
        ...
        <input type="hidden" name="id" value="<?= (!empty($dataRow->id)) ? $dataRow->id : ""; ?>" />
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" name="ok_qty" id="ok_qty" class="form-control numericOnly req qtyCal" min="0" value="<?= (!empty($dataRow->ok_qty)) ? floatVal($dataRow->ok_qty) : "0" ?>" readonly> 
            </div>
            <div class="col-md-4 form-group">
                <label for="hold_qty">Hold Qty.</label>
                <input type="text" name="hold_qty" id="hold_qty" class="form-control numericOnly req qtyCal" min="0" value="<?= (!empty($dataRow->hold_qty)) ? floatVal($dataRow->hold_qty) : "0" ?>"> 
            </div>
            <hr style="width:100%">
