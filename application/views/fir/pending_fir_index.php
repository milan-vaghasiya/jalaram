                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item"> <a href="<?= base_url($headData->controller . "/pendingFirIndex/") ?>" class="btn waves-effect waves-light btn-outline-info  permission-write mr-1 active"> Pending FIR</a> </li>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='firTable' class="table table-bordered ssTable" data-url='/getPendingFirDTRows'></table>
                        </div>
                    </div>
                </div>
            </div>
