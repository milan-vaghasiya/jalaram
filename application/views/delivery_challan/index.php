                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"> 
                                        <a  href="<?=base_url('deliveryChallan/dispatchRequest')?>" class="btn btn-sm waves-effect waves-light btn-outline-info" style="outline:0px" >Dispatch Request</a>
                                    </li>
                                    <li class="nav-item"> 
										<a  href="<?=base_url('deliveryChallan/index/0')?>" class="btn btn-sm waves-effect waves-light btn-outline-success <?=((empty($status))?'active':'')?>" style="outline:0px">Challan</a>
									</li>
                                    <li class="nav-item"> 
										<a  href="<?=base_url('deliveryChallan/index/1')?>" class="btn btn-sm waves-effect waves-light btn-outline-info <?=((!empty($status) && $status == 1)?'active':'')?>" style="outline:0px">Completed</a>
									</li>
                                    <li class="nav-item"> 
										<a  href="<?=base_url('deliveryChallan/index/2')?>" class="btn btn-sm waves-effect waves-light btn-outline-success <?=((!empty($status) && $status == 2)?'active':'')?>" style="outline:0px">Invoiced</a>
									</li>
                                </ul>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='deliveryChallanTable' class="table table-bordered ssTable" data-url='/getDTRows/<?=$status?>'></table>
                        </div>
                    </div>
                </div>
            </div>
