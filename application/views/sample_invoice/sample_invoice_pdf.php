        ...
        <div class="row" style="padding:1.5rem;">
            <div class="col-12">
                <table class="table item-list-bb">
                    <tbody>
                        <tr>
                            <th colspan="8" class="text-right" style="font-size:12px;"><b>No Commercial Value</b></th>
                        </tr>
                        <tr>
                            <th colspan="8" class="text-center" style="font-size:15px;"><b>Invoice cum Packing List</b></th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" rowspan="2" class="text-left">			
                                ...
                                <?=(!empty($dataRow->contact_detail))?"<br>".$dataRow->contact_detail:""?>
                            </td>
                            <td colspan="4"  class="text-left">
                ...
                <table class="table item-list-bb" repeat-header="1">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2" class="text-center" style="border-bottom:none;"></td>
                            <td colspan="3" class="text-center">Freight</td>
                            <td class="text-center"><?=sprintf("%.3f",$dataRow->freight_amount)?></td>
                        </tr>
                        <tr>
                            <td colspan="2" class="text-center" style="border-bottom:none;border-top:none;"><h4>FREE SAMPLE,<h4></td>
                            <td colspan="3" class="text-center">Insuracnce</td>
                            <td class="text-center"><?=sprintf("%.3f",$dataRow->other_amount)?></td>
                        </tr>
                        <tr>
                            <th colspan="2" class="text-center" style="border-bottom:none;border-top:none;"><h4>NO COMMERCIAL VALUE</h4></th>
                            <th colspan="3" class="text-center">Total Amt. in <?=$dataRow->currency?> <br>  (For Custom Purpose Only)</th>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="8" class="text-center">
                                ...
                                <?=numToWordEnglish($dataRow->net_amount)?> (Value for Custom Purpose Only)
                            </td>
                        </tr>
                        <tr>
                ...
                <table class="table item-list-bb" >
                    <tbody>
                        ...
                        <?php
                            if(!empty($packingData)):
                                ...
                                foreach ($packingData as $pack):
                                    ...
                                    $netWt = array_sum(array_column($pack->itemData,'netWeight'));
                                    $packGrWt = (array_sum(array_column($pack->itemData,'netWeight')) + array_sum(array_column($pack->itemData,'pack_weight'))) + $woodenWt;

                                    echo '<tr>';
                                        echo '<td class="text-center">'.$pack->package_no.'</td>';
                                        echo '<td class="text-center">'.$pack->wooden_size.'</td>';
                                        echo '<td class="text-right">'.sprintf("%.3f",$netWt).'</td>';
                                        echo '<td class="text-right">'.sprintf("%.3f",$packGrWt).'</td>';
                                    echo '</tr>';
                                endforeach;
                            endif;
                        ?>
                        ...
                        <tr>
                            <td colspan="2" class="text-left"><b>Declaration:	</b><br><br><br>
                                We declare that this samples are being sent as "FREE SAMPLE" and it has no<br>
                                any Commercial Value. Value shown as above for the Custom Purpose Only.
                            </td>
                            <td colspan="2" class="text-left">
