            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-center">
                        <h4><u>Sample Invoice</u></h4>
                    </div>
                    <div class="card-body">
                        <form autocomplete="off" id="saveSampleInvoice" enctype="multipart/form-data">
                        	<div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label for="contact_detail">Additional Contact Detail</label>
                                        <input type="text" name="extra_fields[contact_detail]" id="contact_detail" class="form-control" value="<?=(!empty($dataRow->contact_detail))?$dataRow->contact_detail:""?>">
                                    </div>
                                </div>
                    ...
                    <div class="card-footer">
                        <div class="col-md-12">
                            <button type="button" class="btn waves-effect waves-light btn-outline-success float-right save-form" onclick="saveSampleInvoice('saveSampleInvoice');" ><i class="fa fa-check"></i> Save</button>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row form-group">
							<div id="itemInputs">
								...
								<input type="hidden" name="drg_rev_no" id="drg_rev_no" value="" />
...
<script src="<?php echo base_url();?>assets/js/custom/sample-invoice-form.js?v=<?=time()?>"></script>
