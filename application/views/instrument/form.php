    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" name="cal_freq" class="form-control floatOnly req" value="<?=(!empty($dataRow->cal_freq))?$dataRow->cal_freq:""?>" />
            </div>
            <div class="col-md-4 form-group">
                <label for="cal_reminder">Plan Before <small>(Days)</small></label>
