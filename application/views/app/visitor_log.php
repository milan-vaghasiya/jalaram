                ...
                <div class="dz-tab style-4">
    				<div class="tab-slide-effect">
    					<ul class="nav nav-tabs"  role="tablist" >
    						...
    						<li class="nav-item " role="presentation">
    							<button class="nav-link buttonFilter" id="profile-tab" data-status="2" data-bs-toggle="tab" data-filter=".issued_req" data-bs-target="#reqList" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false" tabindex="-1">Rejected</button>
    						</li>
...
<div class="modal fade " id="visitorView" tabindex="-1" aria-hidden="true" style="display: none;">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
			    <table class="table P-0">
			        ...
			        <tr>
			            <th>Visit Start</th>
			            <td id="visit_start_time"></td>
			        </tr>
			        <tr>
			            <th>Visit End</th>
			            <td id="visit_end_time"></td>
			        </tr>
			        <tr>
			            <th>Exit</th>
			            <td id="exit_at"></td>
...
$(document).ready(function(){
	...
	$(document).on( 'click', '.buttonFilter', function() {
		...
		$(".message-list").html("");	
		$.ajax({
		url: base_url  + 'app/visitorLogs/getVisitorLogs',
		data:{'status':status},
		type: "POST",
		dataType:"json",
	...
	$(document).on('click','.approveVisit',function(){
		...
		Swal.fire({
			...
			{
				$.ajax({
					url: base_url + 'visitors' + '/approveVisit',
					data: send_data,
					type: "POST",
					dataType:"json",
				}).done(function(response){
