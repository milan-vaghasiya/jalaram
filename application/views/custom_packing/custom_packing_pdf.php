				...
				<table class="table item-list-bb" repeat-header="1">-->
                    ...
                    <tfoot>
						...
						<tr>
							...
							<td class="text-center" colspan="2">Applicable Prefrential  Agreement : <?=$dataRow->applicable_prefrential_agreement?> </td>
							<td class="text-center" colspan="2">Compensation Cess Amount : Not Applicable</td>
							<td class="text-center">Invoice Code : 380000</td>
						</tr>
						<tr>
							<td colspan="3" class="text-center">End Use -GNX 200</td>
