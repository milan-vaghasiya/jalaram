                            ...
                            <div class="col-md-12">
								...
								<div class="row form-group">
									...
									<div class="col-md-3">
										...
										<input type="date" id="inv_date" name="inv_date" class=" form-control req" placeholder="dd-mm-yyyy" value="<?=(!empty($invoiceData->trans_date))?$invoiceData->trans_date:$maxDate?>" min="<?=$startYearDate?>" max="<?=$maxDate?>" />
									</div>
									<div class="col-md-6">
										...
										<div class="row">
										    <div class="col-md-6 form-group">
												...
												<select name="challan_no" id="challan_no" class="form-control singel-select">
													<option value="1" <?=(!empty($invoiceData->challan_no) && $invoiceData->challan_no == 1)?"selected":""?> data-charge="0">NO</option>	
													<option value="2" <?=(!empty($invoiceData->challan_no) && $invoiceData->challan_no == 2)?"selected":""?> data-charge="<?=(!empty($devCharge))?$devCharge:""?>">YES</option>
												</select>
											</div>
											<div class="col-md-6 form-group">
												<label for="dev_charge">Dev. Charge</label>
												<input type="text" name="dev_charge" id="dev_charge" class="form-control floatOnly" value="<?=(!empty($invoiceData->net_weight))?$invoiceData->net_weight:"0"?>" <?=(!empty($invoiceData->challan_no) && $invoiceData->challan_no == 2)?"":"readonly"?> />
											</div>
											<div class="col-md-6 form-group">
												<label class="freight">Freight</label>
												<input type="number" name="freight" id="freight" class="form-control floatOnly" min="0" value="<?=(!empty($invoiceData->freight_amount))?$invoiceData->freight_amount:"0"?>" />
											</div>
											<div class="col-md-6 form-group">
