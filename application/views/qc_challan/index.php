                        ...
                        <div class="row">
                            <div class="col-md-4">
								<ul class="nav nav-pills">
                                    <li class="nav-item"> <button onclick="statusTab('inChallanTable',0);" class="nav-link btn waves-effect waves-light btn-outline-danger active" data-toggle="tab" aria-expanded="false">Pending</button> </li>
                                    <li class="nav-item"> <button onclick="statusTab('inChallanTable',1);" class="nav-link btn waves-effect waves-light btn-outline-success" data-toggle="tab" aria-expanded="false">Completed</button> </li>
                                </ul>
							</div>
                            <div class="col-md-4">
                                <h4 class="card-title text-center">QC Challan</h4></h4>
                            </div>
                            <div class="col-md-4">
