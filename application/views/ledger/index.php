                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="<?=base_url($headData->controller."/opBalIndex")?>" class="btn waves-effect waves-light btn-outline-primary float-right permission-write ml-2" target="_blank"><i class="icon-Money-Bag font-bold font-16"></i> Update Op. Bal.</a>
                            </div>                             
                        </div>                                         
                    </div>
                    <div class="card-body">
