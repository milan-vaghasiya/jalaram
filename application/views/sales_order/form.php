                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form autocomplete="off" id="saveSalesOrder" enctype="multipart/form-data">
                        	<div class="col-md-12">
								<input type="hidden" name="order_id" id="order_id" value="<?=(!empty($dataRow->id))?$dataRow->id:""?>" />
								...
								<div class="row">
									...
									<div class="col-md-2 form-group">
										<label for="so_date">SO. Entry Date</label>
										<input type="date" id="so_date" name="so_date" class=" form-control req" placeholder="dd-mm-yyyy" value="<?=(!empty($dataRow->trans_date))?$dataRow->trans_date:$maxDate?>" min="<?=$startYearDate?>" max="<?=$maxDate?>" />	
									</div>
                                    ...
                                    <div class="col-md-3 form-group">
										...
										<select name="currency" id="currency" class="form-control single-select" >
									...
									<div class="col-md-3 form-group">
										...
										<select name="contact_person" id="contact_person" class="form-control single-select req">
											...
											<?php 
												if(!empty($dataRow->contact_person)){ echo $dataRow->contact_person; }elseif(!empty($orderData->contact_person)){ echo $orderData->contact_person; }
											?>
										</select>
									</div>
									<div class="col-md-3 form-group">
										...
										<select name="contact_no" id="contact_no" class="form-control single-select req">
											...
											<?php  
												if(!empty($dataRow->contact_no)){ echo $dataRow->contact_no; }elseif(!empty($orderData->contact_no)){ echo $orderData->contact_no; }
											?>
										</select>
									</div>
									<div class="col-md-3 form-group">
										...
										<select name="contact_email" id="contact_email" class="form-control single-select req">
											...
											<?php 
    											if(!empty($dataRow->contact_email)){ echo $dataRow->contact_email; }elseif(!empty($orderData->contact_email)){ echo $orderData->contact_email; }
											?>
										</select>
									</div>
									<!--<div class="col-md-2 form-group">
									...
									<div class="col-md-2 form-group">
										...
										<?php
										    $cpono = "";
										    if(!empty($dataRow->doc_no)){$cpono = $dataRow->doc_no;}elseif(!empty($soTransNo)){$cpono = $soTransNo;}
										?>
										<input type="text" name="cust_po_no" id="cust_po_no" class="form-control" placeholder="Enter SO No." value="<?=$cpono?>" />
									</div>
									<div class="col-md-2 form-group">
										<label for="cust_po_date">Cust. PO. Date</label>
										<input type="date" id="cust_po_date" name="cust_po_date" class=" form-control" placeholder="dd-mm-yyyy" value="<?=(!empty($dataRow->doc_date))?$dataRow->doc_date:$maxDate?>" min="<?=$startYearDate?>" max="<?=$maxDate?>" />	
									</div>
									<div class="col-md-3 form-group">
												...
												?>
													<tr>
														...
														<td>
															...
															<input type="hidden" name="prod_target_date[]" value="<?=$row->prod_target_date?>">
														...
														<td>
															...
															<input type="hidden" name="schedule_type[]" value="<?=$row->schedule_type?>">
														</td>
														<td>
															<?=$row->qty?>
										...
										<div class="modal-body">
											<div class="col-md-12 mb-10">
												<table id="terms_condition" class="table table-bordered dataTable no-footer">
													...
													<tbody class="scrollable" style="height:20vh;">
														<?php
															if(!empty($terms)):
                ...
                <form id="orderItemForm">
                    <div class="col-md-12">
                        <div class="row form-group">
							...
							<div class="col-md-12 form-group exp_field">
								<label for="item_alias">Product Alias</label>
								<input type="text" name="item_alias" id="item_alias" class="form-control req" maxlength="255" value="">
							</div>
                            <div class="col-md-6 form-group">
							...
							<div class="col-md-6 form-group">
                                <label for="qty_kg">Estimate Qty</label>
                                <input type="text" name="qty_kg" id="qty_kg" class="form-control floatOnly req" value="0">
                            </div>
                            <div class="col-md-6 form-group">
							...
							<div class="col-md-6 form-group">
								...
								<input type="date" id="delivery_date" name="delivery_date" class=" form-control req" value="<?=$maxDate?>" min="<?=$startYearDate?>" />
							</div>
							<div class="col-md-6 form-group">
								<label for="prod_target_date">Prod. Target Date</label>
								<input type="date" id="prod_target_date" name="prod_target_date" class=" form-control" value="<?=$maxDate?>" min="<?=$startYearDate?>" />
							</div>
							<div class="col-md-6 form-group">
							...
							<div class="col-md-6 form-group">
								...
								<select name="schedule_type" id="schedule_type" class="form-control single-select">
									<option value="">Select</option>
									<option value="1">After Sample</option>
									<option value="2">As Per Schedule</option>
									<option value="3">Only Sample</option>
								</select>
							</div>
                            <div class="col-md-12 form-group">
		...
		foreach($orderItems as $row):
			if(empty($row->trans_status)):
				if(!empty($row->confirm_by)):
					...
					$row->prod_target_date = date("Y-m-d");
					$row = json_encode($row);
