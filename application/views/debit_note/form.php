						...
						<form autocomplete="off" id="saveDebitNote">
							<div class="col-md-12">
								...
								<div class="row form-group">
									<div class="col-md-2">
										...
										<div class="input-group">
											...
											<input type="text" name="trans_no" id="trans_no" class="form-control" value="<?= (!empty($invoiceData->trans_no)) ? $invoiceData->trans_no : $nextTransNo ?>" />
									...
									<div class="col-md-2">
										...
										<input type="date" id="trans_date" name="trans_date" class=" form-control req trans_date" placeholder="dd-mm-yyyy" value="<?= (!empty($invoiceData->trans_date)) ? $invoiceData->trans_date : $maxDate ?>" min="<?=$startYearDate?>" max="<?=$maxDate?>" />
									</div>
									<div class="col-md-3">
								...
								<div class="row form-group">
                                    ...
                                    <div class="col-md-2 form-group">
										<label for="credit_period">Credit Days</label>
										<input type="text" name="credit_period" id="credit_period" class="form-control numericOnly" value="<?=(!empty($invoiceData->credit_period))?$invoiceData->credit_period:""?>">
									</div>
								</div>
							</div>
							<hr>
									...
									<div class="col-md-12">
										<div class="row">
											<div class="col-md-9 form-group">
												<label for="remark">Reason For</label>
					...
					<div class="col-md-12">
						<div class="row form-group">
							...
							<div class="col-md-12 form-group">
								<label form="item_desc">Item Description</label>
							...
							<div class="col-md-4 form-group">
								...
								<input type="text" name="hsn_code" id="hsn_code" class="form-control numericOnly" value="" />
							</div>

							<div class="col-md-4 form-group">
								<label for="gst_per">GST Per.</label>
								<input type="text" name="gst_per" id="gst_per" class="form-control floatOnly" value="" />
							</div>
