                ...
                <div class="card">
                        ...
                        <div class="row">
							<div class="col-md-3">
                                <div class="input-group ">
									<a href="<?=base_url($headData->controller)?>" class="btn btn-info float-right" style="border-radius:0px;">Bill Wise</a>
									<a href="<?=base_url($headData->controller."/itemwiseInvoice")?>" class="btn btn-outline-info float-right" style="border-radius:0px;">Item Wise</a>
								</div>
							</div>
							<div class="col-md-7">
                                <div class="input-group ">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='salesInvoiceTable' class="table table-bordered dtTable dtTable-cf" data-ninput='[0,1]' data-url='/getDTRows/'>
...
<script>
	$(document).ready(function(){
		...
		$(document).on("click",".printInvoiceNew",function(){
			$("#printModel").attr('action',base_url + controller + '/invoice_pdf_lut');
			$("#printsid").val($(this).data('id'));
			$("#print_dialog").modal();
		});
	...
	function getInvoiceSummary(sales_type,from_date,to_date,party_id,pdf){
		...
		if(sales_type == ""){sales_type = '';}if(party_id == ""){party_id = '';}
		var postData = {sales_type:sales_type,from_date:from_date,to_date:to_date,party_id:party_id,pdf:pdf};
